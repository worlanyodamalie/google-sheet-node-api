...
const allowedOrigins = [ 'https://exploredynamo.com' ,'https://1gallon.com.gh','https://exploredynamo.com/','https://1gallon.com.gh/'];

const processSheet = async (req,res) => {
...
module.exports = allowCors(allowedOrigins)(processSheet);
